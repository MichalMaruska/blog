...
> #### private void sendBroadcast() throws Exception { Intent intent = makeIntent(UserHandle.USER\_CURRENT); IntentReceiver receiver = new IntentReceiver(); System.out.println("Broadcasting: " + intent); // this is the fix null -> intent.getType() mAm.broadcastIntent(null, intent, /\* null \*/ intent.getType(), receiver, 0, null, null, mReceiverPermission, android.app.AppOpsManager.OP\_NONE, true, false, mUserId); receiver.waitForFinish(); }
